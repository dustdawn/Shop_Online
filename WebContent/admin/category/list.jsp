				...
				$.post(
					...
					function(data){
						...
						/*for(var i=0;i<data.length;i++){
							...
							for(var i=0;i<data.length;i++){
								content+="<tr onmouseover='this.style.backgroundColor = 'white''"+
								"onmouseout='this.style.backgroundColor = '#F5FAFE';''>"+
								"<td style='CURSOR: hand; HEIGHT: 22px' align='center'"+
									"width='18%''>"+(i+1)+"</td>"+
								"<td style='CURSOR: hand; HEIGHT: 22px' align='center'"+
									"width='17%''>"+data[i].cname+"</td>"+
								"<td align='center' style='HEIGHT: 22px'><a href='${ pageContext.request.contextPath }/admin/category/edit.jsp'>"+
		...
		<TBODY>
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#f5fafe">
					<table id = "showInfo" cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
