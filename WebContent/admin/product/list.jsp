...
<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/admin?method=addProductUI";
			}
			
			function delProduct(pid){
				var isDel = confirm("您确定要删除吗？");
				if(isDel){
					location.href = "${pageContext.request.contextPath}/admin?method=delProductByPid&pid="+pid;
				}
			}
