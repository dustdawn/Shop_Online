...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			$(function(){
				//弹出层插件调用
				new PopupLayer({
					trigger:".clickedElement",  //触发点，点谁弹出div
				...
				$.post(
					...
					function(data){
						...
						/* <tr style='text-align: center;'>
							...
							<td><a target='_blank'>${map.pname }</a></td>
							<td>￥3000</td>
							<td>3</td>
							<td><span class='subtotal'>￥${map.subtotal }</span></td>
						</tr> */
	...
	<body>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/user?method=" method="post">
